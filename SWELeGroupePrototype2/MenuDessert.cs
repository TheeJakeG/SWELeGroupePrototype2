...
{
    public partial class MenuDessert : Form
    {
        public MenuDessert()
        {
            InitializeComponent();
        ...
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0201")));
        }

        private void button1_Click(object sender, EventArgs e)
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0202")));
        }

        private void button2_Click(object sender, EventArgs e)
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0203")));
        }
    }
}
