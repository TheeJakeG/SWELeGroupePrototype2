...
{
    public partial class MenuBread : Form
    {
        public MenuBread()
        {
            InitializeComponent();
        ...
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0101")));
        }

        private void button1_Click(object sender, EventArgs e)
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0102")));
        }

        private void button2_Click(object sender, EventArgs e)
        {
            PCS.Singleton.C_OrderInProgress.Items.Add(PCS.Singleton.RetrieveProduct(ulong.Parse("0103")));
        }
    }
}
